<?php
/**
 * Template Name: Buyer Sellers List
 */
get_header(); ?>
<?php
	...
	$sellers = getSellersUserBlacklist();
																...
																<div class="options-box-shape  white2-bg _options-bg vertical buyer-actions">
																	...
																	<div class="option-cell-transform hidden">
																		...
																		<div class="option-cell-transform">
																			<div class="option-cell-shape white text-center action btnremoveBlacklistedUser"  data-seller="<?php echo $seller['ID']; ?>">
...
jQuery(".btnremoveBlacklistedUser").on("click", function(e) {
	e.preventDefault();
	var user = jQuery(this).attr('data-seller');
