  ...
  <div class="card info-card shadow2  single_table-row">
    <div class="card-body">
      <h4 class="card-title blue">
        <small>Από - Έως</small>
        <input type="text" class="education_dates" value="" placeholder="πχ 2012" />

      </h4>
      <h6 class="text-muted card-subtitle mb-2">
        <small>Τομέας εκπαίδευσης</small>
        <input type="text" class="education_establishment" value="" placeholder="πχ Λογιστής Ά Τάξης" /></h6>
        <p class="card-text black">
          <small>Φορέας πιστοποίησης</small>
          <input type="text" class="education_title" value="" placeholder="πχ Οικονομικό επιμελητήριο" />
    ...
    <form id="<?php echo $form_id;?>" method="post">
      ...
      foreach($single_pool as $single_row)
      {
        ...
        <div class="card info-card shadow2 single_table-row" id="certs<?php echo $row_count++;?>">

          <div class="card-body">
            <h4 class="card-title blue">
              <small>Από - Έως</small>
              <input type="text" class="education_dates" value="<?php echo $fields[0];?>" placeholder="πχ 2012" />

            </h4>
            <h6 class="text-muted card-subtitle mb-2">
              <small>Τομέας εκπαίδευσης</small>
              <input type="text" class="education_establishment" value="<?php echo $fields[1];?>" placeholder="πχ Λογιστής Ά Τάξης" /></h6>
              <p class="card-text black">
                <small>Φορέας πιστοποίησης</small>
                <input type="text" class="education_title" value="<?php echo $fields[2];?>" placeholder="πχ Οικονομικό επιμελητήριο" />
