<?php
/**
 * Template Name: Buyer Sellers List Page
 */
get_header(); ?>
<?php
	$sellers =getUserBlacklistClientsSummary(false);// getUserSellersSummary();
						    ...
						    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 single_seller-col" id="seller-<?php echo $seller['ID']; ?>" data-seller="<?php echo $seller['ID']; ?>">
						        ...
						        <div class='single_seller-transform'>
						          <div class='single_seller-shape shadow radius2'>
						            ...
						            <div class="seller-top blue-bg blue ">
														 ...
														 <div class="seller-bottom-ratio-transform inline-block middle">
															 <div class="seller-bottom-ratio-shape">
																	 <div class="list_avatar blue2 bold circle">
																		 ...
																		 <?php  echo getCustomAvatar($seller['ID'],true); ;//get_avatar($seller['ID']); ?>
																			</div>
																...
																<div class="options-box-shape  white2-bg _options-bg vertical buyer-actions">
																	...
																	<div class="option-cell-transform hidden">
																		...
																		<div class="option-cell-transform ">
																			<div class="option-cell-shape white text-center action btnAddSellerBlacklist"   data-seller="<?php echo $seller['ID']; ?>">
																		...
																		<div class="option-cell-transform">
																			<div class="option-cell-shape white text-center action btnRemoveFromSellers"  data-seller="<?php echo $seller['ID']; ?>">
...
<script type="text/javascript">
	jQuery(".btnAddSellerBlacklist").live("click", function(e) {
		...
		var parentSeller = jQuery(this).closest(".single_seller-transform");
		jQuery.ajax({
			'type'	: 'post',
			'url'		:	ajaxurl,
			'data'	:	{
