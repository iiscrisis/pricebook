<?php
/**
 * Template Name: User Blacklist
 */
get_header(); ?>
<?php
	$withSales = true;
	$blacklistedSellers = getUserBlacklist($withSales);
					...
					<div class="main-area-shape">
						...
						<div id="sellers">
						  ...
						  <div class="sellers-transform">
								...
								if (!empty($blacklistedSellers)) {
	 		 						foreach ($blacklistedSellers as $blacklistedSeller=>$val) { ?>
						            ...
						            <div class="seller-top red-bg">
						              ...
						              <div class='col-xs-8 seller-left'>
						                ...
						                <div class="appl-title black">
						                  ...
						                  <h3 class="black">  <?php echo get_field('seller_companyName','user_'.$blacklistedSeller); ?></h3>
